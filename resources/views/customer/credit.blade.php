                    ...
                    <table class="table table-bordered table-hover w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" colspan="6">لیست مشتریان طلب کار </th>
                            </tr>
                            <tr>
                                <th>نام مشتری</th>
                                <th>تلفن نمبر</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-info">{{ $entry['net_total'] }} <span style="float: left;">AFN</span></td>
                            </tr>
                            @endforeach
                            <tr class="table-secondary">
                                ...
                                <th>{{ $sumDebit }}</th>
                                <th>{{ $sumCredit }}</th>
                                <th class="text-info">{{ ($sumCredit - $sumDebit) }} <span style="float: left;">AFN</span></th>
                            </tr>
